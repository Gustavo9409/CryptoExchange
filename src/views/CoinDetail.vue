    ...
    <template v-if="!isLoading">
      <div class="flex flex-col sm:flex-row justify-around items-center">
        ...
        <div class="my-10 sm:mt-0 flex flex-col justify-center text-center">
          ...
          >
            {{fromUsd ? `From USD to ${asset.symbol}`:`From ${asset.symbol} to USD`}}
          </button>
      ...
      <table>
        <tr class="border-b" v-for="m in markets" :key="`${m.exhangeId}-${m.priceUsd}`">
          <td>
            <b>{{ m.exchangeId }}</b>
          </td>
...
export default {
  ...
  methods: {
    getCoin() {
      ...
      //Permite llamar varias promesas mediante un array y manejar sus resultados cuando todas estas terminen.
